...
select ok((select count(*) from pg_policies where schemaname = 'storage' and tablename = 'objects' and policyname like 'certificates_storage_traceability%') = 3, 'certificate Storage policies are present');
