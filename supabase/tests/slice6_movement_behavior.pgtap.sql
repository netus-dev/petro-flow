...
insert into public.locations (id, name, location_type, company_id)
...
values
  ('b8000000-0000-0000-0000-000000000001', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000001', 'b6000000-0000-0000-0000-000000000001', '97000000-0000-0000-0000-000000000001', true),
  ('b8000000-0000-0000-0000-000000000003', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000001', 'b6000000-0000-0000-0000-000000000001', '97000000-0000-0000-0000-000000000001', true),
  ('b8000000-0000-0000-0000-000000000002', '92000000-0000-0000-0000-000000000002', 'b7000000-0000-0000-0000-000000000002', 'b6000000-0000-0000-0000-000000000002', 'b9000000-0000-0000-0000-000000000002', true);
...
set local role authenticated;
select lives_ok($$select public.register_replacement_movement('{"type":"replacement","location_id":"96000000-0000-0000-0000-000000000001","asset_a_id":"b8000000-0000-0000-0000-000000000001","asset_b_id":"b8000000-0000-0000-0000-000000000003","asset_b_destination_ubication_id":"b6000000-0000-0000-0000-000000000003","justification":"authorized replacement"}'::jsonb)$$, 'authorized replacement succeeds atomically');
set local role postgres;
select is((select current_ubication_id from public.assets where id = 'b8000000-0000-0000-0000-000000000001'), 'b6000000-0000-0000-0000-000000000001'::uuid, 'replacement moves asset A to asset B former position');
select is((select current_ubication_id from public.assets where id = 'b8000000-0000-0000-0000-000000000003'), 'b6000000-0000-0000-0000-000000000003'::uuid, 'replacement moves asset B to requested position');
set local role authenticated;
...
set local role postgres;
select is((select current_ubication_id from public.assets where id = 'b8000000-0000-0000-0000-000000000001'), 'b6000000-0000-0000-0000-000000000001'::uuid, 'rejected replacement leaves assets unchanged');
select * from finish();
rollback;
