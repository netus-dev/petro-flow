...
insert into public.locations (id, name, location_type, company_id) values
  ('e5000000-0000-0000-0000-000000000001', 'Platform A', 'operating_base', 'e2000000-0000-0000-0000-000000000001');
...
insert into public.assets (id, company_id, current_location_id, function_principle_id) values
  ...
  ('e7000000-0000-0000-0000-000000000002', 'e2000000-0000-0000-0000-000000000001', 'e5000000-0000-0000-0000-000000000001', 'e6000000-0000-0000-0000-000000000002');
...
select results_eq($$select name from public.locations order by name$$, $$values ('Platform A'::text)$$, 'reader sees locations used by eligible Hourmeters assets');
